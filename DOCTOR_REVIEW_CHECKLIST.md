...
- **Phone/WhatsApp**: confirm the correct number(s)
- **OPD timings**:
  - Cardiology: days + hours
  - Eye Care: days + hours
...
- **Name** (English + Hindi)
- **Degrees** (MD/DM/MS etc.)
- **Specialty title** (e.g., Interventional Cardiologist / Ophthalmologist & Refractive Surgeon)
- **Memberships / fellowships** (IMA, CSI, FCIMS, FMSRT, etc.)
...
- Pacemaker / ICD / CRT coordination
...
- **Tone**: respectful, professional, patient-friendly (no fear-based language)
